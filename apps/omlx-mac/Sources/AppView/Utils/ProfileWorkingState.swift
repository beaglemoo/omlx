...
enum ProfileSettingsKey {
    ...
    static let expertStreamingCachePolicy = "expert_streaming_cache_policy"
    static let expertStreamingFastResourceLoading = "expert_streaming_fast_resource_loading"
    static let expertStreamingDirectIo = "expert_streaming_direct_io"
    static let expertStreamingNativeDemand = "expert_streaming_native_demand"
    static let expertStreamingDecodeScratchAsCache = "expert_streaming_decode_scratch_as_cache"
    static let expertStreamingIoCoalescingKib = "expert_streaming_io_coalescing_kib"
