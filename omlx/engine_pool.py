    ...
    def _entry_runtime_resident_size(
        ...
        *,
        ...
        if streaming_estimate is not None:
            # Expert streaming governs residency: the bounded per-layer banks,
            # not the checkpoint, decide what stays resident, and the estimate
            # already excludes the mmapped PLE table.
